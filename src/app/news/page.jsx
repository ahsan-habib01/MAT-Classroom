...
export const metadata = {
  ...
  description:
    'Stay updated with the latest news, articles, and insights from MAT Classroom.',
};
...
const newsArticles = [
  {
    ...
    excerpt:
      'Discover the best strategies and study materials to help you ace the upcoming Math Olympiad with confidence and ease.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'We are thrilled to announce five new advanced physics courses covering quantum mechanics, thermodynamics, and astrophysics.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Programming is an essential skill today. Here is our curated list of the best coding platforms to accelerate your software development journey.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Meet our student, David, who just secured first place at the National Science Fair with his innovative renewable energy project.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'AI is transforming how we learn. Explore the benefits and challenges of integrating AI tools in daily educational workflows.',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Apply now for the MAT Classroom Spring Scholarship program. We are offering full and partial scholarships to deserving candidates.',
    image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Stay updated with the latest educational trends, platform
            announcements, and student success stories.
          </p>
        </div>
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <div className="flex items-center text-sm text-gray-500 mb-4 gap-4">
                <span className="flex items-center gap-1">
                  <Calendar className="w-4 h-4" /> {mainArticle.date}
                </span>
                <span className="flex items-center gap-1">
                  <Clock className="w-4 h-4" /> {mainArticle.readTime}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {regularArticles.map(article => (
            <div
              key={article.id}
              className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
            >
        ...
        <div className="mt-20 bg-primary rounded-2xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-blue-100 mb-8 text-lg">
              Get the latest courses, news, and updates delivered right to your
